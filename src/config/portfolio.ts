...
export const portfolioItems: PortfolioItem[] = [
  ...
  },
  {
    ...
    description: "Brief: Design an offline code assistant panel. Constraint: Enforce 4.5:1 text readability over dark UI. Execution: Mapped dynamic system tokens and set up local model adapters.",
    image: "/textures/hero-fallback.jpg",
    aspectRatio: "aspect-square",
